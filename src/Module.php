...
use TFD\Redirects\Facades\Module as FacadesModule;
...
class Module
{
    ...
    public function action($action = null)
    {
        return $this->fluentlyGetOrSet('action')->getter(function ($action) {
            return $action ?? [IndexController::class, 'show'];
        })->args(func_get_args());
    }
    ...
    public function url()
    {
        return cp_route('statamic-redirects::index').'/'.$this->slug();
    }
